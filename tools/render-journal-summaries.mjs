...
<body>
  ...
  <main class="article-main" id="article">
    ...
    <header class="article-head"><div><p class="article-kicker">Внешняя публикация</p><h1>${escapeHtml(meta.title)}</h1><p class="article-deck">${escapeHtml(meta.description)}</p></div><div class="article-meta"><p><strong>${escapeHtml(meta.author)}</strong><br>Редакция 007fin</p><p>14 сентября 2026</p></div></header>
